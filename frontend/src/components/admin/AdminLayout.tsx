...
export const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  if (!isAuthenticated || !isStaff) {
    return (
      <div className="min-h-screen bg-[#F8FAFC] flex flex-col items-center justify-center p-4 text-slate-800 font-sans" dir="rtl">
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex text-slate-800 font-sans relative overflow-x-hidden" dir="rtl">
